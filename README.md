...
Since 2018, I have been writing technical documentation for Oracle Linux, Oracle Cloud, and related technologies. 
I currently use this personal account to interact with my employer's projects.
...
GNU Image Manipulation Program. Archived (read-only) backups for some of those projects are now hosted on [Codeberg](https://codeberg.org/TrechNex).
